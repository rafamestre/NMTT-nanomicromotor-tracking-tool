...
It is recommended to use [Anaconda](https://www.anaconda.com/products/individual) and a specific enviorenment to run this code, to avoid clashes between packages versions, especially with OpenCV. It's recommended to use Python 3.6 or higher. This code should be compatible with Windows, Linux and MacOS, however, it has only been tested in a Windows machine.
